...
?>
            ...
            <body>
                <div class="bg-white">
                    ...
                    <!-- Display Join or Session Button based on student's participation status -->
                    <div class="flex justify-around p-4 bg-zinc-100">
                        ...
                        <button id="sessionButton" class="bg-green-500 text-white rounded-lg px-4 py-2" <?php echo $isJoined ? '' : 'style="display:none;"'; ?>>Session</button>
                    </div>
                </div>
                ...
                <div id="joinForm" class="hidden fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-75 flex items-center justify-center">
                    <div class="bg-white p-8 rounded-lg shadow-md join-form">
                        ...
                        <form id="joinEventForm">
                            <input type="text" id="studentID" name="studentID" value="<?php echo $_SESSION['student_id']; ?>" style="display: none;">
