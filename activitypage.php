    ...
    <body class="bg-zinc-100 text-white font-sans">
        <div class="flex flex-col">
            ...
            <div class="mx-4 my-4 rounded-lg text-center">
                <form method="GET" action="" class="flex items-center p-4 bg-white shadow-md rounded-lg">
                    <input type="text" name="search" placeholder="Search Clubs or Events..." class="flex-grow p-2 border border-zinc-300 rounded-lg">
